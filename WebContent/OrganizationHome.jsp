...
<body>
	...
	<div class="wrapper">
		...
		<div class="sidebar-header">
			<center>
				<div>
					<img src="organization_logo/<%=O.getLogo() %>"
						class="img-circle img-thumbnail img-responsive"
						style='height: 4em; width: 4em;'>
				</div>
				<h3 font='20px'><%=O.getOrganization_name() %></h3>
				<strong></strong>
			</center>
		</div>

		<ul class="list-unstyled components">
			<li class="active"><a href="Organizationhomelink.jsp"
				onclick='sidebarcollapse();' target="iframe"> <i
					class="glyphicon glyphicon-home"></i> Home
			</a></li>
			<li><a href="OrganizationUpdate.jsp" target='iframe'
				onclick='sidebarcollapse();'> <i
					class="glyphicon glyphicon-briefcase"></i> Update Details
			</a> <a href="AddCertificate.jsp?111=<%=O.getOrganization_id() %>"
				target='iframe' onclick='sidebarcollapse();'> <i
					class="glyphicon glyphicon-duplicate"></i> Add Certificate
			</a></li>
			<li><a href="EventRegistration2.jsp" target='iframe'
				onclick='sidebarcollapse();'> <i
					class="glyphicon glyphicon-link"></i> Event Registration
			</a></li>
			<li><a href="DonarMetadata.jsp" target='iframe'
				onclick='sidebarcollapse();'> <i
					class="glyphicon glyphicon-paperclip"></i> Donor's Information
			</a></li>
			<li><a href="Resetpassword.jsp" target='iframe'
				onclick='sidebarcollapse();'> <i
					class="glyphicon glyphicon-paperclip"></i> Reset Password
			</a></li>
		</ul>
		</nav>

		<div class="container-fluid" style="height: 100%; width: 100%;">
			<iframe name="iframe" frameBorder="0" style="width: 100%;"
				onload="resizeIframe(this)" scrolling="yes"
				src="Organizationhomelink.jsp"></iframe>
		</div>
