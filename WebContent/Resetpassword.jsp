		...
		<div class="card-body">
			...
			<form action="Resetpassword" method="post">
				...
				<div class="form-group">
					<label for="pwd">Current Password:</label> <input type="password"
						class="form-control" id="curr_password" name="curr_password"
						required>
				</div>
				...
				<div class="form-group">
					<label for="pwd">Conform Password:</label> <input type="password"
						class="form-control" id="con_password" required>
					<div id="con_message" style="width: 300px;"></div>
				</div>
				<div class="form-group"></div>
				<center>
					<button type="submit" class="btn btn-success" id="sendform">Submit</button>
				</center>
			</form>
		</div>
	</div>
